          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                icon: Icon(_passwordSignInVisible ? Icons.visibility_off : Icons.visibility),
                onPressed: () {
                  setState(() {
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
              suffixIcon: IconButton(
                icon: Icon(_passwordSignUpVisible ? Icons.visibility_off : Icons.visibility),
                onPressed: () {
                  setState(() {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.badge_outlined, color: AppTheme.primaryColor, size: 20),
                    const SizedBox(width: 8),
                    Text(
                      'I am a',
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              title,
              style: TextStyle(color: isSelected ? Colors.white : AppTheme.textDark, fontWeight: FontWeight.w600),
            ),
          ],
        ),
      ),
